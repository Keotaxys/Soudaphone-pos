...
export default function ReportScreen({ salesHistory }: ReportScreenProps) {
  ...
  // 🟢 Header Component (ສ່ວນ Filter ທີ່ຈະເລື່ອນໄປພ້ອມ List)
  const FilterHeader = () => (
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListHeaderComponent={FilterHeader} // 🟢 ເອົາ Filter ມາໄວ້ບ່ອນນີ້
...
const styles = StyleSheet.create({
  ...
  filterSection: { backgroundColor: 'white', paddingBottom: 15, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, elevation: 5, marginBottom: 10 },
  ...
  card: { backgroundColor: 'white', borderRadius: 15, marginBottom: 10, overflow: 'hidden', marginHorizontal: 15, elevation: 2 },
