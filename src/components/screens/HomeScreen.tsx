      ...
      <View style={styles.statsGrid}>
        ...
        <View style={[styles.statCard, { backgroundColor: '#E0F2F1', borderWidth: 1, borderColor: COLORS.primary }]}>
          ...
          <View>
              ...
              <Text style={[styles.statValue, { color: profit >= 0 ? COLORS.primary : ORANGE_COLOR }]}>{profit >= 0 ? '+' : ''}{formatNumber(profit)}</Text>
          </View>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.pickerContainer}>
            ...
            <View style={styles.pickerRow}>
              <TouchableOpacity style={[styles.dateInput, pickerMode === 'start' && showDatePicker && styles.activeDateInput]} onPress={() => { setPickerMode('start'); setShowDatePicker(true); }}>
              ...
              <TouchableOpacity style={[styles.dateInput, pickerMode === 'end' && showDatePicker && styles.activeDateInput]} onPress={() => { setPickerMode('end'); setShowDatePicker(true); }}>
